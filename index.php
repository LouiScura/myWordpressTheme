    ...
    <div class="row">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <img class="d-block w-100" src="<?php bloginfo('template_url'); ?>/carro1.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                <img class="d-block w-100" src="<?php bloginfo('template_url'); ?>/carro2.jpg" alt="Second slide" style="width:1140px !important; height:407px !important">
                </div>
                <div class="carousel-item">
                <img class="d-block w-100" src="<?php bloginfo('template_url'); ?>/carro3.jpg" alt="Third slide" style="width:1140px !important; height:407px !important">
                </div>
            </div>
        ...
        <section class="main col-12 col-sm-12 col-md-9">            
            <div class="row posts">
